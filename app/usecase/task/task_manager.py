...
class TaskManager:
    ...
    def start_task(self, description):
        ...
        return Task(id=0, start_time=start_time, end_time=start_time, description=description)
    ...
    def add_task_manually(self, start_time: datetime, end_time: datetime, description: str) -> bool:
        try:
            ...
            # Crear la tarea
            task = Task(id=0, start_time=start_time, end_time=end_time, description=description)
